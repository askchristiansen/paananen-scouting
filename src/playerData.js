...
function generateVerdict(player) {
  const g = player.stats?.goals ?? 0
  const dribbles = player.stats?.dribbleSucc ?? 0
  const prog = player.stats?.progRuns ?? 0

  if (g > 0.4 && prog > 3) return "BUY"
  if (g > 0.25) return "MONITOR"
  return "PASS"
}
// ─── BENCHMARKS ──────────────────────────────────────────────────────────────
...
export const players = [
  ...
  },
  {
    ...
    marketValue:"€700k", contract:"2028", hasDetailedDashboard:false,
    bio:"Norsk spiss i 1. divisjon med begrenset spilletid (15 kamper). Tallgrunnlaget er for tynt for pålitelige estimater. G/90 på 0.27 er under benchmark — men Sogndal spiller defensivt. Teknisk spiller med god bevegelse, men mangler fysisk dominans. Potensial-kandidat som bør observeres videre.",
  ...
  },
  {
    ...
    bio:"10 kamper er for lite til pålitelig analyse. 1.05 G/90 er ekstraordinært, men basert på 864 minutter i dansk 1. divisjon. Høy overperformance vs xG (0.71).",
  ...
  {
    id:"ballard", name:"D. Ballard", fullName:"Dom Ballard",
    age:20, nationality:"England", flag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",
    posGroup:"CF", position:"CF",
    club:"Leyton Orient", league:"England. League One",
    marketValue:"€800k", contract:"2028", hasDetailedDashboard:false,
    bio:"20-årig engelsk spiss fra Southampton-akademiet med imponerende scoringsfart i League One — 0.65 G/90 over 31 kamper er klart over Christiansen-benchmark. xG/90 0.46 viser at produksjonen er xG-støttet. TouchesPenArea 3.45 er sterkt. Pasningsnøyaktighet 70.0% og duelwin 31.4% er svakt — typisk for en ung, råskudd-orientert spiss i tredje divisjonsnivå. England League One (koeff. 0.85) er god ligavaliditet. Kontrakt t.o.m. 2028. Svært ung — høy skalerings-usikkerhet, men scoringsinstinktet er ekstraordinært.",
    stats:{ goals:0.647, assists:0.062, xG:0.458, shots:2.125, shotsOT:0.985,
      passAcc:70.0, longPassAcc:29.6, dribbleSucc:53.5, dribbles:2.65,
      duelWin:31.4, aerialWin:23.0, interceptions:1.39, recoveriesOpp:2.19,
      touchesPenArea:3.45, progRuns:1.2, shotAssists:0.52, minutes:2923, matches:31 },
  },
  {
    id:"stojakovic", name:"A. Stojaković", fullName:"Aleks Stojaković",
    age:21, nationality:"Slovenia", flag:"🇸🇮",
    posGroup:"CF", position:"CF",
    club:"NK Lokomotiva Zagreb", league:"Croatia. SuperSport HNL",
    marketValue:"€900k", contract:"2027", hasDetailedDashboard:false,
    bio:"21-årig slovensk spiss i Croatia HNL med god scoringsproduksjon — 0.29 G/90 og xG 0.35/90 er akseptabelt for en ung spiss. TouchesPenArea 3.26 og shotsOT 0.84 er over Christiansen-benchmark. Pasning 74.0% og duelwin 34.4% er klart svakt. Aerialwin 33.6% er lavt for en 195 cm spiss. Croatia HNL (koeff. 0.77) er moderat ligakvalitet. Kontrakt t.o.m. 2027. Stor kropp (195 cm) som ikke ennå dominerer luftduellene — potensial om fysikken utvikles. Interessant lavpris-profil.",
    stats:{ goals:0.293, assists:0.042, xG:0.345, shots:2.008, shotsOT:0.837,
      passAcc:74.0, longPassAcc:47.8, dribbleSucc:51.2, dribbles:1.72,
      duelWin:34.4, aerialWin:33.6, interceptions:1.55, recoveriesOpp:2.93,
      touchesPenArea:3.26, progRuns:1.13, shotAssists:0.33, minutes:2151, matches:24 },
  },
  {
    id:"fraulo", name:"G. Fraulo", fullName:"Gustav Fraulo",
    age:20, nationality:"Denmark", flag:"🇩🇰",
    posGroup:"WING", position:"RW",
    club:"Lyngby BK", league:"Denmark. 1st Division",
    marketValue:"€850k", contract:"2028", hasDetailedDashboard:false,
    bio:"20-årig dansk høyrekant i Lyngby med ekstraordinær kreativitet — ShotAss 1.61/90 er høyest i WING-porteføljen. Assistrate 0.21/90 og ProgRuns 2.23/90 er begge over Austbø-benchmark. Interceptions 3.12/90 er svært sterk for en kant — defensiv disiplin. Goals 0.16 og dribbleSucc 54.3% er under benchmark. Denmark 1st Division (koeff. 0.80) er svakere liga — nedjustering nødvendig. Kontrakt t.o.m. 2028. Kreativ profil med sterk assistpotensial.",
    stats:{ goals:0.156, assists:0.208, xG:0.153, shots:1.454, shotsOT:0.675,
      passAcc:79.2, longPassAcc:39.2, dribbleSucc:54.3, dribbles:1.82,
      duelWin:46.3, aerialWin:22.0, interceptions:3.12, recoveriesOpp:6.8,
      touchesPenArea:2.03, progRuns:2.23, shotAssists:1.61, minutes:1733, matches:21 },
  },
  {
    id:"moller", name:"V. Møller", fullName:"Valdemar Møller",
    age:18, nationality:"Denmark", flag:"🇩🇰",
    posGroup:"CM", position:"CM",
    club:"AaB", league:"Denmark. 1st Division",
    marketValue:"€300k", contract:"2027", hasDetailedDashboard:false,
    bio:"18-årig dansk sentral midtbanespiller i AaB — ekstraordinært ung for 1st Division-nivå. Pass% 81.2% er over Askildsen-benchmark. ShotAss 1.15/90 og RecovOpp 3.96/90 er solide. DuelWin 40.7% og progRuns 1.40 er under benchmark. Begrenset spilletid (1091 min, 20 kamper) — bør vektlegges forsiktig. Nevø av Peter Möller. Markedsverdi €25k reflekterer alder — kontrakt t.o.m. 2027. Rå HIGH POTENTIAL-profil med stor nedsiderisiko.",
    stats:{ goals:0.247, assists:0.247, xG:0.257, shots:1.732, shotsOT:0.66,
      passAcc:81.2, longPassAcc:26.3, dribbleSucc:45.8, dribbles:1.98,
      duelWin:40.7, aerialWin:35.1, interceptions:1.9, recoveriesOpp:3.96,
      touchesPenArea:2.31, progRuns:1.4, shotAssists:1.15, minutes:1091, matches:20 },
  },

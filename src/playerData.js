// playerData.js — Scouting platform for Viking FK shadow squad
// Benchmark system: CF→Christiansen, LW/RW/WF→Austbø, CM/AMF→Askildsen, CB→Falchener

// ─── BENCHMARK PLAYERS (Viking FK) ─────────────────────────────────────────
...
export function getBenchmarkKey(position) {
  ...
  if (/\b(CB|LCB|RCB|LB)\b/.test(pos)) return "CB";
  return null;
}

// Compare stat → "better" | "similar" | "weaker"
export function compareVsBenchmark(playerVal, benchVal, _statKey) {
...
// Overall badge for overview table
export function getOverallRating(player) {
  ...
  keyStats.forEach((s) => {
    const r = compareVsBenchmark(player.stats[s] ?? 0, bench.stats[s] ?? 0, s);
    if (r === "better") better++;
    if (r === "weaker") weaker++;
  });
  if (better >= 4) return "better";
  if (weaker >= 4) return "weaker";
  return "similar";
}
...
export const players = [
  // ── Existing players ──────────────────────────────────────────────────────
  {
    ...
    age: 21, nationality: "Finland", flag: "🇫🇮", position: "CF / AMF",
    club: "SJK", league: "Finland. Veikkausliiga",
    hasDetailedDashboard: true, dashboardComponent: "PaananenDashboard",
    stats: {
      goals: 0.55, assists: 0.14, xG: 0.44, shots: 3.1, shotsOT: 1.3,
  ...
  },
  {
    ...
    age: 22, nationality: "France", flag: "🇫🇷", position: "CF",
    club: "FKH", league: "Norway. Eliteserien",
    hasDetailedDashboard: true, dashboardComponent: "DiarraDashboard",
    stats: {
      goals: 0.45, assists: 0.12, xG: 0.38, shots: 2.8, shotsOT: 1.1,
  ...
  },
  {
    ...
    age: 21, nationality: "Norway", flag: "🇳🇴", position: "LWF",
    club: "KBK", league: "Norway. Eliteserien",
    hasDetailedDashboard: true, dashboardComponent: "KilenDashboard",
    stats: {
      goals: 0.38, assists: 0.24, xG: 0.29, shots: 2.4, shotsOT: 0.9,
  ...
  },
  {
    ...
    age: 22, nationality: "Lithuania", flag: "🇱🇹", position: "CF",
    club: "FK Žalgiris", league: "Lithuania. A Lyga", hasDetailedDashboard: false,
    stats: {
      goals: 0.72, assists: 0.10, xG: 0.57, shots: 3.8, shotsOT: 1.7,
  ...
  },
  {
    ...
    age: 25, nationality: "New Zealand", flag: "🇳🇿", position: "AMF",
    club: "HamKam", league: "Norway. Eliteserien", hasDetailedDashboard: false,
    stats: {
      goals: 0.32, assists: 0.24, xG: 0.24, shots: 2.2, shotsOT: 0.9,
  ...
  },
  {
    ...
    age: 23, nationality: "Senegal", flag: "🇸🇳", position: "CB",
    club: "Unknown", league: "Unknown", hasDetailedDashboard: false,
    stats: {
      goals: 0.05, assists: 0.02, xG: 0.04, shots: 0.4, shotsOT: 0.1,
  ...
  },
  {
    ...
    age: 21, nationality: "Norway", flag: "🇳🇴", position: "CB",
    club: "Unknown", league: "Unknown", hasDetailedDashboard: false,
    stats: {
      goals: 0.03, assists: 0.03, xG: 0.03, shots: 0.35, shotsOT: 0.08,
  ...
  },
  {
    ...
    age: 22, nationality: "Norway", flag: "🇳🇴", position: "LAMF",
    club: "Unknown", league: "Norway", hasDetailedDashboard: false,
    stats: {
      goals: 0.37, assists: 0.37, xG: 0.28, shots: 2.5, shotsOT: 1.0,
  ...
  },
  {
    ...
    age: 24, nationality: "Denmark", flag: "🇩🇰", position: "CB",
    club: "Unknown", league: "Denmark", hasDetailedDashboard: false,
    stats: {
      goals: 0.04, assists: 0.04, xG: 0.05, shots: 0.5, shotsOT: 0.1,
  ...
  },
  {
    ...
    age: 22, nationality: "Norway", flag: "🇳🇴", position: "CF",
    club: "Unknown", league: "Norway", hasDetailedDashboard: false,
    stats: {
      goals: 0.27, assists: 0.09, xG: 0.22, shots: 2.0, shotsOT: 0.8,
  ...
  },
  {
    ...
    age: 22, nationality: "Denmark", flag: "🇩🇰", position: "RW",
    club: "Unknown", league: "Denmark", hasDetailedDashboard: false,
    stats: {
      goals: 0.28, assists: 0.21, xG: 0.22, shots: 2.3, shotsOT: 0.9,
  ...
  },
  {
    ...
    age: 23, nationality: "Denmark", flag: "🇩🇰", position: "CF",
    club: "Unknown", league: "Denmark", hasDetailedDashboard: false,
    stats: {
      goals: 0.40, assists: 0.10, xG: 0.38, shots: 3.0, shotsOT: 1.2,
  ...
  },
  {
    ...
    club: "Unknown", league: "Denmark", hasDetailedDashboard: false,
    stats: {
      goals: 1.05, assists: 0.15, xG: 0.71, shots: 4.2, shotsOT: 1.8,
  ...
  },
  {
    ...
    club: "Unknown", league: "Denmark", hasDetailedDashboard: false,
    stats: {
      goals: 0.04, assists: 0.04, xG: 0.04, shots: 0.45, shotsOT: 0.1,
  ...
  },
  {
    ...
    age: 23, nationality: "Ivory Coast", flag: "🇨🇮", position: "CB",
    club: "Unknown", league: "Unknown", hasDetailedDashboard: false,
    stats: {
      goals: 0.04, assists: 0.04, xG: 0.04, shots: 0.4, shotsOT: 0.1,
  ...
  },
  {
    ...
    age: 23, nationality: "Denmark", flag: "🇩🇰", position: "LWF",
    club: "Unknown", league: "Denmark", hasDetailedDashboard: false,
    stats: {
      goals: 0.44, assists: 0.29, xG: 0.33, shots: 2.8, shotsOT: 1.1,
  ...
  // ── New players from this thread ──────────────────────────────────────────
  {
    id: "askildsen", name: "K. Askildsen", fullName: "Kristoffer Askildsen",
    age: 24, nationality: "Norway", flag: "🇳🇴", position: "CM / AMF",
  ...
  },
  {
    ...
    age: 22, nationality: "Scotland", flag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", position: "CB",
    club: "Dundee United", league: "Scotland. Premiership", hasDetailedDashboard: false,
    stats: {
      goals: 0.08, assists: 0.03, xG: 0.09, shots: 0.49, shotsOT: 0.08,
  ...
  },
  {
    ...
    age: 22, nationality: "Sweden", flag: "🇸🇪", position: "CB",
    club: "Sirius", league: "Sweden. Allsvenskan", hasDetailedDashboard: false,
    stats: {
      goals: 0.18, assists: 0.0, xG: 0.13, shots: 0.65, shotsOT: 0.30,
  ...
  },
  {
    ...
    age: 22, nationality: "Nigeria", flag: "🇳🇬", position: "CM / DMF",
    club: "Újpest", league: "Hungary. NB I", hasDetailedDashboard: false,
    stats: {
      goals: 0.05, assists: 0.0, xG: 0.02, shots: 0.91, shotsOT: 0.10,
  ...
  },
  {
    ...
    age: 22, nationality: "Denmark", flag: "🇩🇰", position: "CM / RWF",
    club: "Viborg", league: "Denmark. Superliga", hasDetailedDashboard: false,
    stats: {
      goals: 0.14, assists: 0.21, xG: 0.17, shots: 2.04, shotsOT: 0.77,
  ...
  },
  {
    ...
    age: 22, nationality: "Bosnia", flag: "🇧🇦", position: "CB",
    club: "Sandefjord", league: "Norway. Eliteserien", hasDetailedDashboard: false,
    stats: {
      goals: 0.07, assists: 0.0, xG: 0.09, shots: 0.86, shotsOT: 0.24,
  ...
  },
  {
    ...
    age: 23, nationality: "Denmark", flag: "🇩🇰", position: "CB / LB",
    club: "Horsens", league: "Denmark. 1st Division", hasDetailedDashboard: false,
    stats: {
      goals: 0.06, assists: 0.0, xG: 0.04, shots: 0.37, shotsOT: 0.12,
  ...
  },
  {
    ...
    age: 21, nationality: "Netherlands", flag: "🇳🇱", position: "AMF / CF",
    club: "Vitesse", league: "Netherlands. Eerste Divisie", hasDetailedDashboard: false,
    stats: {
      goals: 0.11, assists: 0.32, xG: 0.16, shots: 1.79, shotsOT: 0.61,
  ...
  },
  {
    ...
    age: 23, nationality: "Wales", flag: "🏴󠁧󠁢󠁷󠁬󠁳󠁿", position: "LB",
    club: "Cardiff City", league: "England. League One", hasDetailedDashboard: false,
    stats: {
      goals: 0.02, assists: 0.10, xG: 0.05, shots: 0.26, shotsOT: 0.07,
  ...
  },
  {
    ...
    age: 22, nationality: "Bulgaria", flag: "🇧🇬", position: "LW / AMF",
    club: "Slavia Sofia", league: "Bulgaria. First League", hasDetailedDashboard: false,
    stats: {
      goals: 0.19, assists: 0.19, xG: 0.18, shots: 1.47, shotsOT: 0.57,
